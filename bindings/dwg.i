...
EXPORT Dwg_Entity_POLYLINE** dwg_getall_POLYLINE (Dwg_Object_Ref* hdr);
...
EXPORT Dwg_Entity_VERTEX** dwg_getall_VERTEX (Dwg_Object_Ref* hdr);
...
EXPORT Dwg_Entity_POLYLINE* dwg_object_to_POLYLINE (Dwg_Object* obj);
...
EXPORT Dwg_Entity_VERTEX* dwg_object_to_VERTEX (Dwg_Object* obj);
