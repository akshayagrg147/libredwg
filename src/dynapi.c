...
static const Dwg_DYNAPI_field _dwg_POLYLINE_2D_fields[] = {
  ...
  { "num_n_verts",	"BS", sizeof (BITCODE_BS),  OFF (struct _dwg_entity_POLYLINE_2D, num_n_verts),
    0,0,0, 0 },
  { "m_density",	"BS", sizeof (BITCODE_BS),  OFF (struct _dwg_entity_POLYLINE_2D, m_density),
    0,0,0, 0 },
  { "n_density",	"BS", sizeof (BITCODE_BS),  OFF (struct _dwg_entity_POLYLINE_2D, n_density),
    0,0,0, 0 },
...
static const Dwg_DYNAPI_field _dwg_POLYLINE_3D_fields[] = {
  { "parent",	"struct _dwg_object_entity*", sizeof (void *),  OFF (struct _dwg_entity_POLYLINE_3D, parent),
    1,1,0, 0 },
  { "flag",	"BS", sizeof (BITCODE_BS),  OFF (struct _dwg_entity_POLYLINE_3D, flag),
    0,0,0, 70 },
  ...
  { "seqend",	"H", sizeof (BITCODE_H),  OFF (struct _dwg_entity_POLYLINE_3D, seqend),
    1,0,0, 0 },
  { "curve_type",	"BS", sizeof (BITCODE_BS),  OFF (struct _dwg_entity_POLYLINE_3D, curve_type),
    0,0,0, 75 },
  ...
  { "extrusion",	"BE", sizeof (BITCODE_BE),  OFF (struct _dwg_entity_POLYLINE_3D, extrusion),
    0,0,0, 0 },
  { "num_m_verts",	"BS", sizeof (BITCODE_BS),  OFF (struct _dwg_entity_POLYLINE_3D, num_m_verts),
    0,0,0, 0 },
  { "num_n_verts",	"BS", sizeof (BITCODE_BS),  OFF (struct _dwg_entity_POLYLINE_3D, num_n_verts),
    0,0,0, 0 },
  { "m_density",	"BS", sizeof (BITCODE_BS),  OFF (struct _dwg_entity_POLYLINE_3D, m_density),
    0,0,0, 0 },
  { "n_density",	"BS", sizeof (BITCODE_BS),  OFF (struct _dwg_entity_POLYLINE_3D, n_density),
    0,0,0, 0 },
  {NULL,	NULL,	0,	0,	0,0,0, 0},
};
...
static const Dwg_DYNAPI_field _dwg_POLYLINE_MESH_fields[] = {
  ...
  { "curve_type",	"BS", sizeof (BITCODE_BS),  OFF (struct _dwg_entity_POLYLINE_MESH, curve_type),
    0,0,0, 75 },
  { "start_width",	"BD", sizeof (BITCODE_BD),  OFF (struct _dwg_entity_POLYLINE_MESH, start_width),
    0,0,0, 0 },
  { "end_width",	"BD", sizeof (BITCODE_BD),  OFF (struct _dwg_entity_POLYLINE_MESH, end_width),
    0,0,0, 0 },
  { "extrusion",	"BE", sizeof (BITCODE_BE),  OFF (struct _dwg_entity_POLYLINE_MESH, extrusion),
    0,0,0, 0 },
...
static const Dwg_DYNAPI_field _dwg_POLYLINE_PFACE_fields[] = {
  ...
  { "seqend",	"H", sizeof (BITCODE_H),  OFF (struct _dwg_entity_POLYLINE_PFACE, seqend),
    1,0,0, 0 },
  { "curve_type",	"BS", sizeof (BITCODE_BS),  OFF (struct _dwg_entity_POLYLINE_PFACE, curve_type),
    0,0,0, 0 },
  { "start_width",	"BD", sizeof (BITCODE_BD),  OFF (struct _dwg_entity_POLYLINE_PFACE, start_width),
    0,0,0, 0 },
  { "end_width",	"BD", sizeof (BITCODE_BD),  OFF (struct _dwg_entity_POLYLINE_PFACE, end_width),
    0,0,0, 0 },
  { "extrusion",	"BE", sizeof (BITCODE_BE),  OFF (struct _dwg_entity_POLYLINE_PFACE, extrusion),
    0,0,0, 0 },
  { "num_m_verts",	"BS", sizeof (BITCODE_BS),  OFF (struct _dwg_entity_POLYLINE_PFACE, num_m_verts),
    0,0,0, 71 },
  { "num_n_verts",	"BS", sizeof (BITCODE_BS),  OFF (struct _dwg_entity_POLYLINE_PFACE, num_n_verts),
    0,0,0, 72 },
  { "m_density",	"BS", sizeof (BITCODE_BS),  OFF (struct _dwg_entity_POLYLINE_PFACE, m_density),
    0,0,0, 0 },
  { "n_density",	"BS", sizeof (BITCODE_BS),  OFF (struct _dwg_entity_POLYLINE_PFACE, n_density),
    0,0,0, 0 },
  {NULL,	NULL,	0,	0,	0,0,0, 0},
};
...
static const Dwg_DYNAPI_field _dwg_VERTEX_2D_fields[] = {
  ...
  { "tangent_dir",	"BD", sizeof (BITCODE_BD),  OFF (struct _dwg_entity_VERTEX_2D, tangent_dir),
    0,0,0, 50 },
  { "vertind[4]",	"BS", 4 * sizeof (BITCODE_BS),  OFF (struct _dwg_entity_VERTEX_2D, vertind),
    0,0,0, 0 },
  {NULL,	NULL,	0,	0,	0,0,0, 0},
};
...
static const Dwg_DYNAPI_field _dwg_VERTEX_3D_fields[] = {
  ...
  { "point",	"3BD", sizeof (BITCODE_3BD),  OFF (struct _dwg_entity_VERTEX_3D, point),
    1,0,0, 10 },
  { "start_width",	"BD", sizeof (BITCODE_BD),  OFF (struct _dwg_entity_VERTEX_3D, start_width),
    0,0,0, 0 },
  { "end_width",	"BD", sizeof (BITCODE_BD),  OFF (struct _dwg_entity_VERTEX_3D, end_width),
    0,0,0, 0 },
  { "id",	"BL", sizeof (BITCODE_BL),  OFF (struct _dwg_entity_VERTEX_3D, id),
    0,0,0, 0 },
  { "bulge",	"BD", sizeof (BITCODE_BD),  OFF (struct _dwg_entity_VERTEX_3D, bulge),
    0,0,0, 0 },
  { "tangent_dir",	"BD", sizeof (BITCODE_BD),  OFF (struct _dwg_entity_VERTEX_3D, tangent_dir),
    0,0,0, 0 },
  { "vertind[4]",	"BS", 4 * sizeof (BITCODE_BS),  OFF (struct _dwg_entity_VERTEX_3D, vertind),
    0,0,0, 0 },
  {NULL,	NULL,	0,	0,	0,0,0, 0},
};
...
static const Dwg_DYNAPI_field _dwg_VERTEX_PFACE_FACE_fields[] = {
  ...
  { "flag",	"RC", sizeof (BITCODE_RC),  OFF (struct _dwg_entity_VERTEX_PFACE_FACE, flag),
    0,0,0, 70 },
  { "point",	"3BD", sizeof (BITCODE_3BD),  OFF (struct _dwg_entity_VERTEX_PFACE_FACE, point),
    1,0,0, 0 },
  { "start_width",	"BD", sizeof (BITCODE_BD),  OFF (struct _dwg_entity_VERTEX_PFACE_FACE, start_width),
    0,0,0, 0 },
  { "end_width",	"BD", sizeof (BITCODE_BD),  OFF (struct _dwg_entity_VERTEX_PFACE_FACE, end_width),
    0,0,0, 0 },
  { "id",	"BL", sizeof (BITCODE_BL),  OFF (struct _dwg_entity_VERTEX_PFACE_FACE, id),
    0,0,0, 0 },
  { "bulge",	"BD", sizeof (BITCODE_BD),  OFF (struct _dwg_entity_VERTEX_PFACE_FACE, bulge),
    0,0,0, 0 },
  { "tangent_dir",	"BD", sizeof (BITCODE_BD),  OFF (struct _dwg_entity_VERTEX_PFACE_FACE, tangent_dir),
    0,0,0, 0 },
