...
static const Dwg_DYNAPI_field _dwg_VERTEX_R11_fields[] = {
  ...
  { "tangent_dir",	"RD", sizeof (BITCODE_RD),  OFF (struct _dwg_entity_VERTEX_R11, tangent_dir),
    0,0,0, 0 },
  { "vertind[4]",	"RS", 4 * sizeof (BITCODE_RS),  OFF (struct _dwg_entity_VERTEX_R11, vertind),
    0,0,0, 0 },
  {NULL,	NULL,	0,	0,	0,0,0, 0},
};
...
static const struct _name_type_fields dwg_name_types[] = {
  ...
  { "POLYLINE_R11", DWG_TYPE_POLYLINE_R11 /*(739)*/, _dwg_POLYLINE_R11_fields, sizeof (struct _dwg_entity_POLYLINE_R11) },	/* 250 */
  ...
  { "VERTEX_2D", DWG_TYPE_VERTEX_2D /*(10)*/, _dwg_VERTEX_2D_fields, sizeof (struct _dwg_entity_VERTEX_2D) },	/* 302 */
  { "VERTEX_3D", DWG_TYPE_VERTEX_3D /*(11)*/, _dwg_VERTEX_3D_fields, sizeof (struct _dwg_entity_VERTEX_3D) },	/* 303 */
  { "VERTEX_MESH", DWG_TYPE_VERTEX_MESH /*(12)*/, _dwg_VERTEX_3D_fields, sizeof (struct _dwg_entity_VERTEX_3D) },	/* 304 */
  { "VERTEX_PFACE", DWG_TYPE_VERTEX_PFACE /*(13)*/, _dwg_VERTEX_3D_fields, sizeof (struct _dwg_entity_VERTEX_3D) },	/* 305 */
  { "VERTEX_PFACE_FACE", DWG_TYPE_VERTEX_PFACE_FACE /*(14)*/, _dwg_VERTEX_PFACE_FACE_fields, sizeof (struct _dwg_entity_VERTEX_PFACE_FACE) },	/* 306 */
  { "VERTEX_R11", DWG_TYPE_VERTEX_R11 /*(740)*/, _dwg_VERTEX_R11_fields, sizeof (struct _dwg_entity_VERTEX_R11) },	/* 307 */
