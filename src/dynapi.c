...
static const struct _name_subclass_fields dwg_list_subclasses[] = {
  ...
  { "TABLESTYLE_cellstyle", (int)DWG_TYPE_TABLESTYLE, NULL, _dwg_TABLESTYLE_cellstyle_fields, sizeof (Dwg_TABLESTYLE_cellstyle) },	/* 108 */
  { "TABLESTYLE_rowstyle", (int)DWG_TYPE_TABLESTYLE, NULL, _dwg_TABLESTYLE_rowstyle_fields, sizeof (Dwg_TABLESTYLE_rowstyle) },	/* 109 */
